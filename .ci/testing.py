...
if __name__ == "__main__":
    ...
    response = None
    if manager.get_branch() == "stable/3.5.2" and not manager.is_pull_request() and os.getenv("ARCH") == "x86":
        if ci_manager.is_travis():
            json_data = {"request": {"branch": "release/3.5.2"}}
            ...
            json_data = {"accountName":"BinCrafters", "projectSlug": "protobuf-integration-test", "branch": "release/3.5.2"}
